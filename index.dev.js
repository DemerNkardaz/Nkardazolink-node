...
app.get('/:lang?/wiki/:page/:subPage?', async (request, response, next) => {
  ...
  */
  ...
  {{нихон-го:'''Нагаока Хэйидзи Ёсинобу'''|長岡 平意地 義信}} — четвёртый регент [[Рёсёгун|рёсёгуна]] острова [[Татарикири]], владыки горы [[Сумпаку|Су́мпаку]], величественного [[Асидзава Иватомо]].
  <br>
  <p>
